package com.ra.boomblog.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.ra.boomblog.commons.entity.File;
import com.ra.boomblog.commons.entity.FileSort;
import com.ra.boomblog.commons.entity.SystemConfig;
import com.ra.boomblog.picture.global.MessageConf;
import com.ra.boomblog.picture.global.SQLConf;
import com.ra.boomblog.picture.global.SysConf;
import com.ra.boomblog.picture.mapper.FileMapper;
import com.ra.boomblog.picture.service.*;
import com.ra.boomblog.picture.util.AboutFileUtil;
import com.ra.boomblog.picture.util.FeignUtil;
import com.ra.boomblog.utils.FileUtils;
import com.ra.boomblog.utils.JsonUtils;
import com.ra.boomblog.utils.ResultUtil;
import com.ra.boomblog.utils.StringUtils;
import com.ra.boomblog.base.enums.EFilePriority;
...
import com.ra.boomblog.base.global.ErrorCode;
import com.ra.boomblog.base.holder.RequestHolder;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.ra.boomblog.commons.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.ra.boomblog.commons.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.ra.boomblog.commons.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.ra.boomblog.commons.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.ra.boomblog.commons.entity.File file = new com.ra.boomblog.commons.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
