package com.ra.boomblog.admin.annotion.AvoidRepeatableCommit;
...
public class AvoidRepeatableCommitAspect {
     ...
     * @param point
     */
    @Around("@annotation(com.ra.boomblog.admin.annotion.AvoidRepeatableCommit.AvoidRepeatableCommit)")
