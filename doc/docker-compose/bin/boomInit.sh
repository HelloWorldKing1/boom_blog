...
if ! type docker-compose >/dev/null 2>&1; then
	...
	wget http://oss.boomit.cn/script//docker-compose-Linux-x86_64
...
echo '创建docker网络';
docker network create boom

echo '正在拉取一键部署脚本';
wget http://oss.boomit.cn/script//docker-compose.zip
...
dos2unix boomGoStartup.sh
dos2unix boomGoShutdown.sh
dos2unix update.sh
