package com.ra.boomblog.commons.feign;

import com.ra.boomblog.commons.config.feign.FeignConfiguration;
...
@FeignClient(name = "boom-web", configuration = FeignConfiguration.class)
